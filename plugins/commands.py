...
async def check_force_subscribe(client, message):
    if not UN_CHANNEL: # If UN_CHANNEL list is empty or None, no force subscribe needed
        return []
